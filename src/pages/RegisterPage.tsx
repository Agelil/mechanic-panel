        ...
        {!success ? (
          <form onSubmit={handleSubmit} className="border-2 border-border bg-surface p-8 shadow-brutal">
            ...
            <div className="mt-6 pt-5 border-t border-border text-center">
              <p className="font-mono text-xs text-muted-foreground mb-3">Или войдите быстро</p>
              <Link
                to={`/cabinet`}
                className="inline-flex items-center gap-2 border-2 border-border px-5 py-2.5 font-mono text-sm hover:border-orange hover:text-orange transition-colors"
              >
